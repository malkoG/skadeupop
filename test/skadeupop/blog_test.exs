defmodule Skadeupop.BlogTest do
  use Skadeupop.DataCase

  alias Skadeupop.Blog

  alias Skadeupop.Blog.Post

  @valid_attrs %{body: "some body", published: true, published_at: ~N[2021-11-29 16:25:00], title: "some title", views: 42}
  @update_attrs %{body: "some updated body", published: false, published_at: ~N[2021-11-30 16:25:00], title: "some updated title", views: 43}
  ...
  describe "#create_post/1" do
    test "with valid data creates a post" do
      ...
      assert post.published_at == ~N[2021-11-29 16:25:00]
  ...
  describe "#update_post/2" do
    test "with valid data updates the post" do
      ...
      assert post.published_at == ~N[2021-11-30 16:25:00]
